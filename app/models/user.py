...
class User(BaseModel):
    ...
    def login_to_dict(self):
        ...
        data = dict(
            ...
            avatar=f"https://{Config_is.S3_BUCKET_NAME}.s3.us-east-1.amazonaws.com/avatar/"
    ...
    def generate_auth_token(self, expiration: int = Config_is.AUTH_TOKEN_EXPIRES):
        ...
        token = s.dumps(
            {'id': self.id, 'first_name': self.first_name, 'last_name': self.last_name, 'role_id': self.role_id, 'email': self.email})
